...
DECLARE_INSTANCE_PRIVATE_CONSTR_TYPE(ConfigManager);
DECLARE_INSTANCE_PRIVATE_CONSTR_TYPE(EditorManager);
DECLARE_INSTANCE_PRIVATE_CONSTR_TYPE(UserVariableManager);
DECLARE_INSTANCE_PRIVATE_CONSTR_TYPE(ScriptingManager);
DECLARE_INSTANCE_PRIVATE_CONSTR_TYPE(EditorBase);
DECLARE_INSTANCE_PRIVATE_CONSTR_TYPE(cbEditor);
...
DECLARE_INSTANCE_PRIVATE_CONSTR_TYPE(ProjectManager);
